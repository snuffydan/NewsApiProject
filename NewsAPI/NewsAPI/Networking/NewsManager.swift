...
class NewsManager {
    ...
    static func getLatestNews(completionHandler: @escaping (_ result:LatestNewsResponse?) -> Void) {
        ...
        case .success( _):
            if(responseData.data != nil)
            {
                do {
                    ...
                    let newsResponse = try decoder.decode(LatestNewsResponse.self, from:
                        responseData.data!)
                    print(newsResponse)
    ...
    static func getNewsByCategory(category: String, completionHandler: @escaping (_ result:LatestNewsResponse?) -> Void) {
